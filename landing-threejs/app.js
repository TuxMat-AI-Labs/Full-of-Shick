/* ============================================================
   ...
   ============================================================ */
const ASSETS = {
  heroLoop: null,       // left null on purpose: keeps the live Three.js hero render
  problemCompare: 'assets/problem-compare.jpg', // Porsche interior, wide
  coverageMap: 'assets/coverage-map.jpg',    // BMW interior
  macroEdge: 'assets/macro-edge.jpg',        // retention hook detail
  macroSurface: 'assets/macro-surface.jpg',  // engineered ridges
  macroLight: 'assets/macro-light.jpg',      // badge detail under light
};

/* hero3d.js reads this to decide whether the hero renders live or
   plays a delivered asset. A heroLoop file always wins over the render. */
